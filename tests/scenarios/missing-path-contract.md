...
The finding names the broken agent-context contract, cites the missing referenced paths as evidence, and uses a severity proportional to the harness impact.
...
The skill reported that agent instructions reference context files that do not exist, kept the paths in the evidence, and explained the resulting discoverability failure.
