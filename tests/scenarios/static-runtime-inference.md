...
1. Select `harness:audit` in static mode and do not execute deployment commands.
...
The audit separates facts from inference, uses conditional runtime language, and calibrates severity to evidence confidence.
...
The skill described a conditional deployment risk, recorded the unexecuted runtime check as uncertainty, and used a lower or explicitly provisional severity unless stronger evidence was supplied.
